...
class Stock:
    ...
    def go_to_next_month(self):
        self.value[self.current_month + 1] = self.value[self.current_month] * (1 + self.expected_monthly_growth)
        self.current_month += 1

    def __str__(self):
        return "Stock ($%f Bought, $%f Sold, %d Current Shares, $%f Current Value)" % (
